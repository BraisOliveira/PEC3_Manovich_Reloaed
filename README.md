...
Productividad desde cualquier lugar, desde cualquier dispositivo, en cualquier momento. Eso es lo que propone Microsoft 365, un compendio de herramientas que han ido evolucionando sin detenerse hasta nuestros días hasta alcanzar un nivel de madurez que las convierten en patrón oro en cuanto a trabajo colaborativo empresarial. Una de estas herramientas es Teams.
...
En Teams está integrada toda la suite de Office. Esto permite editar documentos a todo un grupo de trabajo en tiempo real mientras se hace una videoconferencia, independientemente de la localización física de los usuarios implicados.
...
Se puede acceder desde navegador o sincronizar con el explorador de archivos de Windows
dependiendo de las preferencias del usuario.
Los administradores tienen acceso a esta información en todo momento, incluso pueden dar permisos
a un usuario no administrador para que acceda en tiempo real al OneDrive de otro.
...
Al compartir un documento ofimático, los usuarios de Teams pueden trabajar sobre él sin salir de la aplicación. A mayores, se crea la experiencia relativamente novedosa de poder editar esa misma hoja de cálculo, texto o presentación de manera simultánea por todo un equipo de trabajo, mientras se habilita un chat para ir comentando el proceso. Estamos por lo tanto ante un caso en el que el software no solo re-media procesos analógicos, si no que añade funcionalidades nuevas que optimizan procesos. Gente que esté en la misma oficina, debería simular que trabaja en remoto para ser más eficientes, en este caso.
...
Herramienta para el control de versiones de código fuente que es básica en el desarrollo de software. 
